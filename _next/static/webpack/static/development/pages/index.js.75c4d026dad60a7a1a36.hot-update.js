...
var createDeclaration = function createDeclaration(t, specifier, source) {
  return t.variableDeclaration("const", [t.variableDeclarator(t.identifier(t.identifier(specifier.local.name)), t.memberExpression(t.callExpression(t.identifier(resolverId), [t.stringLiteral(source.value)])))]);
};
...
//# sourceMappingURL=index.js.75c4d026dad60a7a1a36.hot-update.js.map